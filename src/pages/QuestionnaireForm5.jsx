            ...
            <Container>
                <Box sx={{ maxWidth: 500, mx: "auto", mt: 6, p: 3, border: "1px solid gray", borderRadius: 2, boxShadow: "0 2px 3px blue" }}>
                    ...
                    <Typography variant="h6" mt={3}>
                        1. Do you have any access to reproductive health information?
                    </Typography>
                    <Controller
                    ...
                    {hasHealthInfo && (
                        <>
                            <Typography variant="h6" mt={3}>
                                1b. If yes, who mostly educates you on reproductive health issues? (Tick as many)
                            </Typography>
                            <Controller
                                name="healthInfoAccess"
                                control={control}
                    ...
                    {hasHealthInfo && (
                        <>
                            <Typography variant="h6" mt={3}>
                                1c. Which topics do they normally cover? (Tick as many)
                            </Typography>
                            <Controller
                                name="healthTopics"
                                control={control}
                    ...
                    {hasHealthInfo && (
                        <>
                            <Typography variant="h6" mt={3}>
                                1d. Is the information adequate?
                            </Typography>
                            <Controller
                                name="infoAdequacy"
                                control={control}
                    ...
                    {/* Next Button */}
                    <Button onClick={onSubmit} type="submit" variant="contained" color="success" fullWidth sx={{ mt: 4 }}>
                        Submit and Finish
                    </Button>
                </Box>
            </Container>
